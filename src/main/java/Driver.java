...
public class Driver {
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException, InterruptedException {
		...
		// Use dbConfiguration to configure all the jdbcDriver, db user, db password,
		// database
		...
		// to add external dependency to current project
		/*
		 * 1. upload dependency to hdfs 2. define the dependency path on hdfs (use
		 * "addArchiveToClassPath" method)
		 */
		job2.addArchiveToClassPath(new Path("path_to__connector"));
		// Because map output key and value are inconsistent with reducer output key and
		// value
